...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/yuanweichen/Weex.git"
  ...
  s.source       = { :git => "https://github.com/yuanweichen/Weex.git", :tag => s.version.to_s }
  ...
  s.source_files  = "WeexDemo/Weex/**/*.{h,m,swift}"
